...
<div class="row">
<div class="col-lg-12">
<h1 class="page-header"><i class="fa fa-folder fa-fw"></i> Edit Category
...
<div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-plus-circle fa-fw"></i> Modify
                        </div>
                        <!-- /.panel-heading -->
			...
			<form id="form" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
						<input class="text-input form-control" name="title" value="<?php echo $data["title"]; ?>" id="txttitle" type="text" required=""  /> (Ex. ABC Series)
					</div>
                    </div>
                    <div class="form-group">
