                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example" >
                                    ...
                                    <? foreach($data as $d){ ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?=$d["cl_fees"]; ?></td>
                                            <td><?=$d["cl_discount"]; ?></td>
                                            <td><a href="<?=common::get_component_link(array("clinic","photos"),array("cl_id"=>$d["cl_id"]))?>" class="btn btn-default">Add Photos</a></td>
                                            <td><a href="<?=common::get_component_link(array("clinic","services"),array("cl_id"=>$d["cl_id"],"dr_id"=>common::get_control_value("dr_id")))?>" class="btn btn-default">Service Charges</a></td>
                                            <td><a href="<?=common::get_component_link(array("clinic","timetable"),array("cl_id"=>$d["cl_id"],"dr_id"=>common::get_control_value("dr_id")))?>" class="btn btn-default">Set Time</a></td>
                                            <td class="center">
